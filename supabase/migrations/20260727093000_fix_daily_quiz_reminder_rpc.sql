-- Avoid PL/pgSQL ambiguity between local variables and reminder column names.
  ...
  loop
    ...
    if requested_target_type = 'common' then
      ...
      where student.class_id = p_class_id
        ...
        and student_group.group_code = requested_group_code
    ...
    if inserted_recipient_count = 0 then
      raise exception 'empty_quiz_reminder_audience';
    end if;
